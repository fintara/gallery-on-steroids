/*
 * Copyright (C) 2013 Google Inc.//from   w ww .  ja va2  s .c  o  m
 *
...
public class WaveformView extends SurfaceView {
    ...
    private static final float MAX_AMPLITUDE_TO_DRAW = 8192.0f * 0.5f;
    ...
    private void drawWaveform(Canvas canvas) {
        ...
        for (short[] buffer : mAudioData) {
            mPaint.setColor(Color.argb(brightness, 25, 100, 126));
